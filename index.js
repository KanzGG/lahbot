...
const BotName = 'kanzBOTZ'; // GANTI PAKE NAMA BOT LU
...
const ow = 'kanz Ganz'; // GANTI PAKE NAMA MU
const nomorowner = '085559240360'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = 'blm ada'; // GANTI PAKE NOMOR OVO LU
const pulsa = '082148505737'; // GANTI PAKE NOMOR PULSA LU
const dana = 'blm ada'; // GANTI PAKE NOMOR DANA LU
const gopay = 'blm ada; // GANTI PAKE NOMOR GOPAY LU
const instagram = 'gak ada malas buat'; // GANTI IG LU
const aktif = '08:00 - 22:00'; // TERSERAH LU DAH INI
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n' // MAU NGAPAIN TOD
  + 'FN:Kanzu GANS\n' // GANTI PAKE NAMA MU
  + 'ORG:Kanz Bot;\n' // INI BIARIN GPP, GANTI PAKE NAMA BOT BOLEH
  + 'TEL;type=CELL;type=VOICE;waid=62822452100:+62 821 4850 5737\n' // GANTI PAKE NOMOR LU ( SAMAIN KEK GITU YA )
